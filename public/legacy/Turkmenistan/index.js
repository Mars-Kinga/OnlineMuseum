document.addEventListener("DOMContentLoaded", function () {
  ...
  const dotsData = [
    { topPercent: 78, leftPercent: 72, text: "碎叶城遗址" },
    { topPercent: 80, leftPercent: 70, text: "塔什拉巴特驿站" },
    { topPercent: 82, leftPercent: 60, text: "萨伊马鲁-塔什岩画群" }
  ];
